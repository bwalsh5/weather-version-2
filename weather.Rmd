...
</svg>](https://www.github.com/bwalsh5/)


<p id="red">This report analyzes the average temepraoefh s;f dslkfjhsl kfj
as seen on </p>

<a href="http://www.laalmanac.com/weather/we04a.php" target="_blank">Link to Original Data</a>
...
as.data.frame(weather_table) -> weather_df
```
